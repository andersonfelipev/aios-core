...
async function runWizard() {
  try {
    ...
    // Install Expansion Packs if selected - kept for backward compatibility
    ...
    if (answers.selectedIDEs && answers.selectedIDEs.length > 0) {
      ...
      // Install expansion pack agents to each selected IDE (kept for backward compatibility)
    ...
    // Story 1.5/1.8: MCP Installation - commented out as per upstream
